	(function(){
		...
		var arrayIDs = new Array("basePanelText","basePanel","auth","authRestore","profileMenu","profileLeftColumn","profileUserData","profileUserVerbList","profileSmokeBlock","bothListHeaders","fullListTableHeader","portionListTableHeader","verbsList","verbsListPortion","exerciseItems","infoPanelPage","infoPanelTimer","resultTable","resultTableButton","pageInfo1","listC1","pageInfo2","listC2","pageInfo3","listC3","displayIfZeroFailed");
		var parentIDs;
