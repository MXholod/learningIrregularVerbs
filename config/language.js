		...
		"exercises":{
			"exerciseItems":{
				"exercise1":[
					...
					"У тебя есть одна попытка, чтобы отметить вариант верным либо неверным. Неверный  вариант  - это если один из трёх глаголов в ряду является не соответствующим списку неправильных глаголов.",
					"Время на прохождение: 200 секунд. Желаем удачи!",
					"Начать"
				],
				"exercise2":[
					"Упражнение «Место  истины»",
					"Перетаскивая смешанные глаголы из списка справа, необходимо положить их на свои истинные места в пустых строках.",
					"Время на прохождение: 250 секунд. Желаем удачи!",
					"Начать"
				],
				"exercise3":[
					"Упражнение «Умный писатель»",
					"На этом этапе тебе предстоит прописать все пропущенные глаголы в строках.",
					"Время на прохождение: 330 секунд. Желаем удачи!",
					"Начать"
				]
			}
		},
		...
		"exercises":{
			"exerciseItems":{
				"exercise1":[
					...
					"У тебе є одна спроба, щоб відзначити варіант вірним або невірним. Невірний варіант - це якщо один з трьох дієслів в ряду є не відповідним списку неправильних дієслів.",
					"Час на проходження: 200 секунд. Бажаємо успіху!",
					"Почати"
				],
				"exercise2":[
					"Вправа «Місце істини»",
					"Перетягуючи змішані дієслова зі списку праворуч, необхідно покласти їх на свої справжні місця в порожніх рядках.",
					"Час на проходження: 250 секунд. Бажаємо успіху!",
					"Почати"
				],
				"exercise3":[
					"Вправа «Розумний письменник»",
					"На цьому етапі тобі належить прописати всі пропущені дієслова в рядках.",
					"Час на проходження: 330 секунд. Бажаємо успіху!",
					"Почати"
				]
			}
		},
